...
gabFrame.base_component=function(){
    var base_component={
        ...
        sendRequest:function(code,url,caller,data,title,Nasync,cache,dataType,type,errorCaller,contentType){
            try{
                this.abort(code);
            }catch (e){}
            this.ajaxCollect[code]=sendRequest(url,caller,data,title,Nasync,cache,dataType,type,errorCaller,contentType);
        },
