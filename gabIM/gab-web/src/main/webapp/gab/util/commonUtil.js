...
function initFormWindow() {
    ...
    gabFrame.formWin.showFooter=function(isShow){
        var $footer=gabFrame.formWin.win.find(".modal-footer");
        if(isShow){
            $footer.show();
        }else{
            $footer.hide();
    ...
    gabFrame.formWin.show=function(title,view,hideFooter){
        gabFrame.formWin.header.html(title);
        gabFrame.formWin.body.empty().append(view);
        gabFrame.formWin.showFooter(!hideFooter);
    ...
    gabFrame.formWin.close=function(){
    	gabFrame.formWin.win.modal('hide');
    }
};
