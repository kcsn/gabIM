...
//	}
//
//	public static final void set(final String key, final Serializable value, int expire) {
//		getRedis().opsForValue().set(key, value);
//		expire(key, expire);
//	}
//
...
//		expire(key, EXPIRE);
//		if(!exists(key)){
//			set(key,Long.valueOf(1));
//		}
//		return getRedis().boundValueOps(key).increment(integer);
//	}
//
//	public static final void setObjectAsString(final String key, final Serializable value, int expire) {
//		String str= JSON.toJSONString(value);
//		getRedis().opsForValue().set(key, str);
//		expire(key, expire);
//	}
//	// 未完，待续...
//}