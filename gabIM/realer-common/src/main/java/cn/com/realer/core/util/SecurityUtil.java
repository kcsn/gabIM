...
import cn.com.realer.core.support.security.BASE64Encoder;
import cn.com.realer.core.support.security.coder.*;
...
//		System.out.println(verifyRSA(org, publicKey, sign));
		...
		// System.out.println(s);
		// }
//		String a="amount=1&beginTime=20170223123640&cashierNo=1050&comment=&currency=CNY&orderNo=1702230520&oriTradeNo=10000001000100261702230000199&payType=1&serierNo=ffcb24509bde2db2&key=UnionPay-2016MX";
//		String s="amount=1&beginTime=20170223123640&cashierNo=1050&currency=CNY&orderNo=1702230520&oriTradeNo=10000001000100261702230000199&payType=1&serierNo=ffcb24509bde2db2&key=UnionPay-2016MX";
//		System.out.println(DigestUtils.md5Hex(a).toUpperCase());
